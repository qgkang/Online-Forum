...
<form id="form1" name="form1" method="post" action="">
    <table width="998" height="500" border="0" align="center" cellpadding="0" cellspacing="0" id="__01">
        ...
        <tr>
            ...
            <td width="744" height="448" rowspan="7" align="center" valign="middle" bgcolor="#FFFDF1">
                <table width="633" height="376">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td width="386" align="left">
                            ...
                            while($array1=mysql_fetch_array($select1)){
                                ?>
                                <input type="radio" name="tx" value="<?php echo $array1['id'];?>" /> <img src="<?php echo "../05/image_1.php?recid=".$array1['id'];?>" width="24" height="24">
                                <?php
                            }
                            ?></td>
                    ...
                    <tr>
                        <td colspan="3" align="center">
                            <input type="submit" name="Submit" value="主题提交" />
                            <input type="submit" name="Submit2" value="重置信息" />
                        </td>
                    </tr>
                </table>
            </td>
