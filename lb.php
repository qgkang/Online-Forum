...
<body>
    ...
    $page_page = ceil($rows/$page_count);
    //获取上一页的最后一条记录
...
<table width="987" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="#E1DAEA">
    <tbody>
    <tr>
        <td height="30" colspan="2" align="center" bgcolor="#FFFBF0" class="STYLE4">
            <?php
...
<table width="987" border="1" align="center" cellpadding="1" cellspacing="1" bordercolor="#FFFFFF" bgcolor="E1DAEA">
    <tbody>
        ...
        <?php
            $selects = mysql_query("select * from tb_content where category='$category' order by id desc limit $offset,$page_count",$conn);
            while($array = mysql_fetch_array($selects)){
        ?>
        <tr>
            <td align="center"><a href="lb_ok.php?id=<?php echo $array['id'];?>"><?php echo $array['subject'];?></a></td>
            <td align="center"><?php echo $array['content'];?></td>
            <td align="center"><?php echo $array['username'];?></td>
            <td align="center"><?php echo $array['release_date'];?></td>
        </tr>
    </tbody>
    <?php }?>
    <tr class="style1" align="middle">
        <td height="35" colspan="4" align="center" bgcolor="#FFFBF0">
            <table width="80%" border="0" cellspacing="0" cellpadding="0">
                <tr class="style4">
                    <td width="50%" class="#ff0000">页次：<?php echo $page;?>/<?php echo $page_page;?>页 记录：<?php echo $rows;?>条&nbsp; </td>
